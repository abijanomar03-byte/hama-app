...
export default async function Home() {
  ...
  return (
    <main className="page">
      ...
      <section className="section"><div className="container">
        <div className="section-head">
          <div>
            ...
            <div className="muted">{all.length.toLocaleString()} houses currently available</div>
          </div>
      ...
      <footer className="footer"><div className="container">Hama · Tenant-powered house hunting.</div></footer>
    </main>
  )
}
